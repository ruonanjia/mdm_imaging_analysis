...
templates = {'func': os.path.join(data_root, 'sub-{subject_id}', 'ses-1', 'func', 'sub-{subject_id}_ses-1_task-{task_id}_space-MNI152NLin2009cAsym_desc-preproc_bold.nii.gz'),
             ...
             'events': os.path.join('/home/rj299/project/mdm_analysis/output/', 'event_files', 'sub-{subject_id}_task-{task_id}_cond_v6.csv')}
...
# SV
cont10 = ['Med_Amb_Reward_Prob', 'T', cond_names, [0, 1, 0, 0, 0, 0, 0, 0]]
cont11 = ['Med_Risk_Reward_Prob', 'T', cond_names, [0, 0, 0, 1, 0, 0, 0, 0]]
cont12 = ['Mon_Amb_Reward_Prob', 'T', cond_names, [0, 0, 0, 0, 0, 1, 0, 0]]
cont13 = ['Mon_Risk_Reward_Prob', 'T', cond_names, [0, 0, 0, 0, 0, 0, 0, 1]]
...
########################################################################
# Datasink
datasink = Node(nio.DataSink(base_directory=os.path.join(output_dir, 'Sink_resp_reward_prob')),
                                         name="datasink")
