...
templates = {'cons': os.path.join('/home/rj299/scratch60/mdm_analysis/output/imaging/Sink_resp_reward_prob/1stLevel/_subject_id_{subject_id}/', 
                         '{contrast_id}.nii')}
...
datasink = Node(nio.DataSink(base_directory='/home/rj299/scratch60/mdm_analysis/output/imaging/Sink_resp_reward_prob/'),
                name="datasink")


l2analysis = Workflow(name='l2spm_reward_prob_glm_heightp05')
